...
<title>Editar Categoria — Sistema Salomão</title>
...
<main class="max-w-4xl mx-auto px-6 py-10">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-neutral-900">Editar Categoria</h1>
        <p class="text-neutral-500 mt-1">Alterando a categoria "{{ $category->name }}".</p>
    </div>
