...
export default function TransactionsEdit({ transaction, categories }) {
    ...
    return (
        <AppLayout>
            ...
            <main className="max-w-3xl mx-auto px-6 py-10">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-neutral-900">Editar Transação</h1>
                    <p className="text-neutral-500 mt-1">Altere os dados da transação.</p>
                </div>
